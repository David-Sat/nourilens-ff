...
import 'schema/full_receipt_record.dart';
...
export 'schema/full_receipt_record.dart';
...
Future<int> queryReceiptsRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      ReceiptsRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
/// Functions to query FullReceiptRecords (as a Stream and as a Future).
Future<int> queryFullReceiptRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FullReceiptRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FullReceiptRecord>> queryFullReceiptRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      FullReceiptRecord.collection(parent),
      FullReceiptRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FullReceiptRecord>> queryFullReceiptRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
